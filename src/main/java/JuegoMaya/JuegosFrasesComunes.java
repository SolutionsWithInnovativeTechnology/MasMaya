...
public class JuegosFrasesComunes extends javax.swing.JFrame {
    Jugador jugador;
    ReproductorSonido reproductor = ReproductorSonido.getInstancia();

    public JuegosFrasesComunes(Jugador jugador) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 67, 428, -1));

        jPanel2.setBackground(new java.awt.Color(219, 239, 254));

        btnImgCrucigrama.setBackground(new java.awt.Color(219, 239, 254));
        btnImgCrucigrama.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngCompletarPalabras.png"))); // NOI18N
        ...
        btnImgCrucigrama.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngCompletarPalabras1.png"))); // NOI18N
        ...
        btnImgMemorama.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngOrdenarPalabras.png"))); // NOI18N
        ...
        btnImgMemorama.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngOrdenarPalabras1.png"))); // NOI18N
        ...
        btnImgPuzzle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngRelacionar.png"))); // NOI18N
        ...
        btnImgPuzzle.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngRelacionar1.png"))); // NOI18N
        ...
        btnImgRelacionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngTraducir.png"))); // NOI18N
        ...
        btnImgRelacionar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/img/pngTraducir1.png"))); // NOI18N
        ...
        jLabel3.setText("Relaciona frases");

        jLabel4.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Completa la frase");

        jLabel5.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Ordena palabras");

        jLabel6.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Traducir");
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGap(18, 18, 18)
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(btnImgMemorama, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(btnImgInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 580, 34, 37));
        ...
        jPanel1.add(btnImgInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 580, 34, 37));
        ...
        jPanel1.add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(314, 0, 206, 34));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("Puntuación global:");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(294, 40, 125, -1));
        jPanel1.add(lblpuntuacionGlobal, new org.netbeans.lib.awtextra.AbsoluteConstraints(425, 40, 49, 15));
        ...
        jPanel1.add(btnSonido, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 20, 34, 37));
    ...
    private void btnImgInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImgInfoActionPerformed
        InformacionFrasesComunes info = new InformacionFrasesComunes(jugador);
    ...
    private void btnImgMemoramaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImgMemoramaActionPerformed
        OrdenaPalabras palabras = new OrdenaPalabras(jugador);
    ...
    private void btnImgPuzzleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImgPuzzleActionPerformed
        RelacionarFrases palabras = new RelacionarFrases(jugador);
        palabras.setVisible(true);
        this.dispose();
    ...
    private void btnImgRelacionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImgRelacionarActionPerformed
        Traducir traducir = new Traducir(jugador);
    ...
    private void btnImgCrucigramaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImgCrucigramaActionPerformed
        CompletarLaFrase palabras = new CompletarLaFrase(jugador);
        palabras.setVisible(true);
        this.dispose();
