...
public class AdivinaElAnimal extends javax.swing.JFrame {
    ...
    private void comenzarJuego() {
        ...
        String imagenPath = "/imgAnimales/" + palabras[palabra][0] + ".png";
    ...
    private void comprobarPalabra(String palabraB) {
        if (palabras[palabra][1].equals(palabraB)) {
            ...
            JOptionPane.showMessageDialog(this, "Has perdido. Tu puntaje es: 0", "Fin del juego :(", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(56, 66, 418, -1));

        btnImgSoporte.setBackground(new java.awt.Color(219, 239, 254));
        ...
        jPanel1.add(btnImgSoporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 380, 34, 37));
        ...
        jPanel1.add(btnImgInicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, 34, 37));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(262, 33, -1, -1));
        jPanel1.add(lblpuntuacionGlobal, new org.netbeans.lib.awtextra.AbsoluteConstraints(389, 33, 49, 15));

        reiniciar.setBackground(new java.awt.Color(219, 239, 254));
        ...
        jPanel1.add(reiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 82, -1));

        lblintentos.setText("Intentos:");
        jPanel1.add(lblintentos, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, -1, -1));

        lblIntentos.setText("1");
        jPanel1.add(lblIntentos, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 390, 37, -1));
        ...
        opcion1.setBackground(new java.awt.Color(219, 239, 254));
        ...
        opcion2.setBackground(new java.awt.Color(219, 239, 254));
        ...
        opcion3.setBackground(new java.awt.Color(219, 239, 254));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 134, -1, -1));
